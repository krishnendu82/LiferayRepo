...
public class GuestbookServiceHttp {
	...
	public static com.liferay.poc.guestbook.model.Guestbook addGuestbook(
		...
		try {
			...
			return (com.liferay.poc.guestbook.model.Guestbook)returnObj;
		}
	...
	public static com.liferay.poc.guestbook.model.Guestbook deleteGuestbook(
		...
		try {
			MethodKey methodKey = new MethodKey(
				GuestbookServiceUtil.class, "deleteGuestbook",
				_deleteGuestbookParameterTypes1);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, guestbookId, serviceContext);
	...
	public static java.util.List<com.liferay.poc.guestbook.model.Guestbook>
		...
		try {
			...
			return (java.util.List<com.liferay.poc.guestbook.model.Guestbook>)
				returnObj;
		}
		catch (com.liferay.portal.kernel.exception.SystemException
					systemException) {
	...
	public static com.liferay.poc.guestbook.model.Guestbook updateGuestbook(
		...
		try {
			MethodKey methodKey = new MethodKey(
				GuestbookServiceUtil.class, "updateGuestbook",
				_updateGuestbookParameterTypes5);

			MethodHandler methodHandler = new MethodHandler(
				methodKey, userId, guestbookId, name, serviceContext);
	...
	private static final Class<?>[] _deleteGuestbookParameterTypes1 =
		new Class[] {
	...
	private static final Class<?>[] _getGuestbooksCountParameterTypes4 =
		new Class[] {long.class};
	private static final Class<?>[] _updateGuestbookParameterTypes5 =
		new Class[] {
